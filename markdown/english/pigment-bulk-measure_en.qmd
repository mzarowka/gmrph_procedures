...
[![](images/log-ug_pl.png){fig-alt="Logo: University of Gdansk" fig-align="left" width="150"}](https://geomorfologia.ug.edu.pl)
...
-   Microcuvettes **400 µl** with caps.
...
-   Pipette **400 µl** acetone (**100%**, **HPLC**) to cuvette.
...
-   Using pipette transfer **400 µl** of extract into a cuvette.
...
Maurycy Żarczyński, Department of Geomorphology and Quaternary Geology, Gdansk
