...
# Dane batymetryczne (echosonda Humminbird 385ci)
...
-   Sonda po znalezieniu pozycji GPS (diagnostyka GPS jest dostępna w odpowiednim widoku, klawisz `View`) rejestruje ślad cały czas, ale **nie zapisuje** go autoamtycznie na stałe.
...
-   Włączyć oprogramowanie HumminbirdPC.
    ...
    Instalator dostępny w lokalizacji: *Public\\Sprzęt i programy\\Software\\Humminbird*
    {{< pagebreak >}}
