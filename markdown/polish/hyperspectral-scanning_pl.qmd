...
-   Połączyć się z komputerem korzystając ze zdalnego pulpitu.
    ...
    | *Public\\Sprzęt i programu\\Network\\B106_HSI.vnc*

    | Połączenie VNC możliwe z użyciem programów:
...
![Obiektyw 18.5 mm](images/specim-18.5.png){alt="Obiektyw 18.5 mm" width="25%"}

![Obiektyw 50.0 mm](images/specim-50.0.png){alt="Obiektyw 50.0 mm" width="25%"}

{{< pagebreak >}}

## Załącznik 2: etykiety

![Wzór etykiet jednorazowych (źródło: Butz 2016)](images/hsi_labels.jpg){fig-align="center" width="60%"}
